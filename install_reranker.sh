...
apt-get install -y -qq python3.10 python3.10-venv python3.10-distutils curl coreutils > /dev/null
...
echo "[4/4] Starting Reranker Server in BACKGROUND..."
echo "--------------------------------------------------------------------------"
...
echo " SUCCESS! Reranker is running in the background."
echo " Logs are being saved to: /root/reranker.log"
